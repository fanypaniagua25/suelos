                                ...
                                <table class="table table-bordered table-hover datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <th>Updated</th>
                                            @canany(['update propiedades', 'delete propiedades'])
                                                <th>Action</th>
                                            @endcanany
                                        </tr>
                                    </thead>
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('propiedades.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="input-group">
                            <label>Name</label>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('propiedades.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
